    ...
    <div className="about-page">
      ...
      >
        ...
        <div className="about-description">
          ...
          <p>
            בין הרצאות, שיחות והקרנה מיוחדת, תושק גם החוברת{' '}
            <span className="highlight-text">עוד יותר טוב ועוד יותר טוב</span>{' '}
            - פרויקט מחקר ועיצוב הבוחן את השפה החזותית של כסף, עבודה, צריכה, צמיחה ומיתוג עצמי, ואת האופן שבו הכלכלה מעצבת לא רק את המציאות אלא גם את הדמיון.
          </p>
        </div>
      </div>
    </div>
